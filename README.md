...
## 4. 역할
- 양진수 :  PyQt5를 활용한 UI 제작
- 김동언 : UI 이외 제작

## 5. 배운 것
- 키움API를 활용한 투자 자동화 프로그램 제작 때 고민했었던 PyQt5를 활용해서 UI와 관련된 메소드를 연결하는 연습을 할 수 있었다.
- UI 부분을 제작하면서 관제를 해야할 내용들이나 화면 배치에 대해 고민하였고, 해킹메일대응훈련 간에 식별된 접수 간 관리 필요 요소들에 대해 고민할 수 있었다.
- 비록 UI부분을 주로 담당하였지만 이를 합치는 과정 중에서 웹 스크래핑과 DB 연결 등 다양한 부문에 대해서 공부할 수 있었다.
- 협업하는 과정에서 메소드명이나 변수 이름, 메소드 이름을 정하는 과정 등 혼자 코딩 시에서는 고려하지 않아도 되는 부분들을 토의해가며 학습할 수 있었다.
